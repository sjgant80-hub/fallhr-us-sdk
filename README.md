...
**◊ FallHR · sovereign US HR anchor · employees · holiday · absence · reviews · ERA 1996** — sovereign SDK extracted from `fallhr-us/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallhr-us-sdk
```

## Use
```js
import * as fallhr-us from '@ai-native-solutions/fallhr-us-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallhr-us-sdk/
- MCP wrapper: [`@ai-native-solutions/fallhr-us-mcp`](https://github.com/sjgant80-hub/fallhr-us-mcp)
- HTTP API: [`@ai-native-solutions/fallhr-us-api`](https://github.com/sjgant80-hub/fallhr-us-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallhr-us-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallhr-us-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallhr-us-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallhr-us-sdk -- npx -y @ai-native-solutions/fallhr-us-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallhr-us-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallhr-us-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallhr-us-sdk/
- **Source**: https://github.com/sjgant80-hub/fallhr-us-sdk
